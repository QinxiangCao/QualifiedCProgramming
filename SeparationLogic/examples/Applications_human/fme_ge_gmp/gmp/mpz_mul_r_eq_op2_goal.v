...
Definition mpz_mul_entail_wit_2_split_goal_spatial := 
forall (op2_pre: Z) (rop_pre: Z) (z2: Z) (z1: Z) (rptr_2: Z) (rsize_2: Z) (rcap_2: Z) (op1size_2: Z) (op2ptr: Z) (op2size_2: Z) (op2cap_2: Z) (l1_2: (@list Z)) (l2_2: (@list Z)) (rn: Z) (un: Z) (vn: Z) (sign: Z) (retval: Z) (x_callee__mp_size: Z) (ptr: Z) (PreH1 : (ptr <> 0)) (PreH2 : (x_callee__mp_size = 0)) (PreH3 : (retval <> 0)) (PreH4 : (rop_pre = op2_pre)) (PreH5 : (rn = (un + vn ))) (PreH6 : (un > 0)) (PreH7 : (vn > 0)) (PreH8 : (0 <= sign)) (PreH9 : (sign <= 1)) (PreH10 : (mpz_mul_sign sign op1size_2 op2size_2 )) (PreH11 : (un <= INT_MAX)) (PreH12 : (vn <= INT_MAX)) (PreH13 : ((un + vn ) <= INT_MAX)) (PreH14 : (un = (Zabs (op1size_2)))) (PreH15 : (vn = (Zabs (op2size_2)))) (PreH16 : (op1size_2 <> 0)) (PreH17 : (op2size_2 <> 0)) (PreH18 : (same_sign z1 op1size_2 )) (PreH19 : (same_sign z2 op2size_2 )) (PreH20 : (rptr_2 = op2ptr)) (PreH21 : (rsize_2 = op2size_2)) (PreH22 : (rcap_2 = op2cap_2)) (PreH23 : ((Zabs (rsize_2)) <= rcap_2)) (PreH24 : (rcap_2 >= 0)) (PreH25 : (rcap_2 <= INT_MAX)) (PreH26 : ((Zlength (l1_2)) = un)) (PreH27 : ((Zlength (l2_2)) = vn)) (PreH28 : (list_within_bound UINT_MOD l1_2 )) (PreH29 : (list_within_bound UINT_MOD l2_2 )) (PreH30 : ((list_to_Z (UINT_MOD) (l1_2)) = (Zabs (z1)))) (PreH31 : ((list_to_Z (UINT_MOD) (l2_2)) = (Zabs (z2)))) (PreH32 : ((last (l1_2) (1)) >= 1)) (PreH33 : ((last (l2_2) (1)) >= 1)) ,
  (UIntArray.undef_full ptr (un + vn ) )
|--
  (UIntArray.undef_full ptr (un + vn ) )
...
(
forall (op2_pre: Z) (op1_pre: Z) (rop_pre: Z) (z2: Z) (z1: Z) (rptr: Z) (rsize: Z) (rcap: Z) (op1ptr: Z) (op1size: Z) (op1cap: Z) (op2ptr: Z) (op2size: Z) (op2cap: Z) (l1: (@list Z)) (l2: (@list Z)) (rn: Z) (un: Z) (vn: Z) (sign: Z) (retval: Z) (PreH1 : (op2cap <= INT_MAX)) (PreH2 : (op2size <= INT_MAX)) (PreH3 : (op1cap <= INT_MAX)) (PreH4 : (op1size <= INT_MAX)) (PreH5 : (sign <= INT_MAX)) (PreH6 : (rn <= INT_MAX)) (PreH7 : (op2cap >= INT_MIN)) (PreH8 : (op2size >= INT_MIN)) (PreH9 : (op1cap >= INT_MIN)) (PreH10 : (op1size >= INT_MIN)) (PreH11 : (sign >= INT_MIN)) (PreH12 : (vn >= INT_MIN)) (PreH13 : (un >= INT_MIN)) (PreH14 : (rn >= INT_MIN)) (PreH15 : (retval <> 0)) (PreH16 : (rop_pre = op2_pre)) (PreH17 : (rn = (un + vn ))) (PreH18 : (un > 0)) (PreH19 : (vn > 0)) (PreH20 : (0 <= sign)) (PreH21 : (sign <= 1)) (PreH22 : (mpz_mul_sign sign op1size op2size )) (PreH23 : (un <= INT_MAX)) (PreH24 : (vn <= INT_MAX)) (PreH25 : ((un + vn ) <= INT_MAX)) (PreH26 : (un = (Zabs (op1size)))) (PreH27 : (vn = (Zabs (op2size)))) (PreH28 : (op1size <> 0)) (PreH29 : (op2size <> 0)) (PreH30 : (same_sign z1 op1size )) (PreH31 : (same_sign z2 op2size )) (PreH32 : (rptr = op2ptr)) (PreH33 : (rsize = op2size)) (PreH34 : (rcap = op2cap)) (PreH35 : ((Zabs (rsize)) <= rcap)) (PreH36 : (rcap >= 0)) (PreH37 : (rcap <= INT_MAX)) (PreH38 : ((Zlength (l1)) = un)) (PreH39 : ((Zlength (l2)) = vn)) (PreH40 : (list_within_bound UINT_MOD l1 )) (PreH41 : (list_within_bound UINT_MOD l2 )) (PreH42 : ((list_to_Z (UINT_MOD) (l1)) = (Zabs (z1)))) (PreH43 : ((list_to_Z (UINT_MOD) (l2)) = (Zabs (z2)))) (PreH44 : ((last (l1) (1)) >= 1)) (PreH45 : ((last (l2) (1)) >= 1)) ,
  ((&((retval)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |->_)
  **  ((&((retval)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |->_)
  **  ((&((retval)  # "__mpz_struct" ->ₛ "_mp_d")) # Ptr  |->_)
  **  ((( &( "rop" ) )) # Ptr  |-> rop_pre)
