...
Lemma proof_of_mpn_add_1_entail_wit_3_1_non_alias : mpn_add_1_entail_wit_3_1_non_alias.
Proof.
  pre_process.
...
Lemma proof_of_mpn_add_1_entail_wit_3_2_non_alias : mpn_add_1_entail_wit_3_2_non_alias.
Proof.
  pre_process.
  rename PreH9 into Hlen_l'.
  rename PreH10 into Hval_sub.
...
Proof.
  ...
  entailer!; unfold UINT_MOD in *; simpl; pose proof (unsigned_Lastnbits_range (Znth 0 l 0 + b0_non_alias) 32); try lia.
  replace (0 + 1) with 1 by lia.
  entailer!.
...
Proof.
  unfold mpn_add_1_return_wit_2_rp_eq_ap.
  right.
  pre_process.
  assert (Hi : i = n_pre) by lia.
  subst i.
