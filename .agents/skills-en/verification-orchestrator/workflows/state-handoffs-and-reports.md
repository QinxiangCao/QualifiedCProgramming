...
| `group_worker_output.md` | Group-worker | Normally optional proof notes; for annotation-gap it must be a nonempty UTF-8 regular file at the fixed path and itemize affected witnesses and evidence, and its digest enters the finalized `artifact_sha256` |
