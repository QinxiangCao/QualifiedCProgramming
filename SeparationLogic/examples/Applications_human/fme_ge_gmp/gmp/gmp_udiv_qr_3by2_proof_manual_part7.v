...
Lemma proof_of_gmp_udiv_qr_3by2_entail_wit_8_4 : gmp_udiv_qr_3by2_entail_wit_8_4.
Proof.
  unfold gmp_udiv_qr_3by2_entail_wit_8_4.
  right.
  intros.
  subst m qpre qext.
...
Lemma proof_of_gmp_udiv_qr_3by2_entail_wit_8_5 : gmp_udiv_qr_3by2_entail_wit_8_5.
Proof.
  unfold gmp_udiv_qr_3by2_entail_wit_8_5.
  right.
  intros.
  subst m qpre qext.
  change UINT_MOD with 4294967296 in *.
  ...
  - dump_pre_spatial.
    ...
    replace ((rpre1 + d1_pre) * 4294967296 + (rpre0 + d0_pre))
      with (rpre1 * 4294967296 + rpre0 + (d1_pre * 4294967296 + d0_pre)) by abstract ring.
...
Lemma proof_of_gmp_udiv_qr_3by2_entail_wit_8_6 : gmp_udiv_qr_3by2_entail_wit_8_6.
Proof.
  unfold gmp_udiv_qr_3by2_entail_wit_8_6.
  right.
  intros.
  subst m qpre qext.
  change UINT_MOD with 4294967296 in *.
  ...
  - dump_pre_spatial.
    rewrite Hhi, Hlow.
    replace ((rpre1 + d1_pre + 1) * 4294967296 + (rpre0 + d0_pre - 4294967296))
      with (rpre1 * 4294967296 + rpre0 + (d1_pre * 4294967296 + d0_pre)) by abstract ring.
    assert (HB2_le_2D: 4294967296 * 4294967296 <=
                       2 * (d1_pre * 4294967296 + d0_pre)).
    { change (4294967296 ÷ 2) with 2147483648 in PreH11.
