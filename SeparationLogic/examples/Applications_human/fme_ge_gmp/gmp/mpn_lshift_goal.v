...
|--
  ...
  &&  “ ((Znth ((n_pre - 1 )) (l_up_inplace) (0)) <= UINT_MAX) ” 
  &&  “ (0 <= (Znth ((n_pre - 1 )) (l_up_inplace) (0))) ” 
  &&  “ ((((unsigned_last_nbits ((Z.shiftl low_limb_2 cnt_pre)) (32)) + ((list_to_Z (UINT_MOD) ((app ((replace_Znth (((i_2 + 1 ) - (i_2 + 1 ) )) ((Z.lor high_limb_2 (Z.shiftr low_limb_2 tnc_2))) ((sublist ((i_2 + 1 )) ((i_2 + 2 )) (l_up_inplace))))) (l_done_3)))) * UINT_MOD ) ) + (retval_2 * (Z.pow (UINT_MOD) ((n_pre - i_2 ))) ) ) = ((list_to_Z (UINT_MOD) ((sublist (i_2) (n_pre) (l_up_inplace)))) * (Z.pow (2) (cnt_pre)) )) ” 
  &&  “ ((unsigned_last_nbits ((Z.shiftl low_limb_2 cnt_pre)) (32)) = (unsigned_last_nbits (((Znth (i_2) (l_up_inplace) (0)) * (Z.pow (2) (cnt_pre)) )) (32))) ” 
  &&  “ (list_within_bound UINT_MOD (app ((replace_Znth (((i_2 + 1 ) - (i_2 + 1 ) )) ((Z.lor high_limb_2 (Z.shiftr low_limb_2 tnc_2))) ((sublist ((i_2 + 1 )) ((i_2 + 2 )) (l_up_inplace))))) (l_done_3)) ) ” 
  &&  “ ((Zlength ((app ((replace_Znth (((i_2 + 1 ) - (i_2 + 1 ) )) ((Z.lor high_limb_2 (Z.shiftr low_limb_2 tnc_2))) ((sublist ((i_2 + 1 )) ((i_2 + 2 )) (l_up_inplace))))) (l_done_3)))) = (n_pre - (i_2 + 1 ) )) ”
  &&  emp
).
