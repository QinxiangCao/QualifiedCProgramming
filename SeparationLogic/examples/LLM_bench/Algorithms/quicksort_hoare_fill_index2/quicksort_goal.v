...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (pivot = (Znth (low_pre) (l) (0)))) (PreH2 : ((Zlength (l)) = n)) (PreH3 : (1 <= n)) (PreH4 : (n <= 50000)) (PreH5 : (0 <= low_pre)) (PreH6 : (low_pre <= high_pre)) (PreH7 : (high_pre < n)) (PreH8 : (low_pre <= i)) (PreH9 : (i <= j)) (PreH10 : (j <= high_pre)) (PreH11 : (partition_hole_outer_inv l l1 low_pre high_pre pivot i j )) ,
  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "low" ) )) # Int  |-> low_pre)
  **  ((( &( "high" ) )) # Int  |-> high_pre)
  **  ((( &( "pivot" ) )) # Int  |-> pivot)
...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : ((Znth j l1 0) > pivot)) (PreH2 : (i < j)) (PreH3 : (pivot = (Znth (low_pre) (l) (0)))) (PreH4 : ((Zlength (l)) = n)) (PreH5 : (1 <= n)) (PreH6 : (n <= 50000)) (PreH7 : (0 <= low_pre)) (PreH8 : (low_pre <= high_pre)) (PreH9 : (high_pre < n)) (PreH10 : (low_pre <= i)) (PreH11 : (i <= j)) (PreH12 : (j <= high_pre)) (PreH13 : (partition_hole_outer_inv l l1 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "low" ) )) # Int  |-> low_pre)
  **  ((( &( "high" ) )) # Int  |-> high_pre)
...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i >= j)) (PreH2 : ((Znth j l1 0) <= pivot)) (PreH3 : (i < j)) (PreH4 : (pivot = (Znth (low_pre) (l) (0)))) (PreH5 : ((Zlength (l)) = n)) (PreH6 : (1 <= n)) (PreH7 : (n <= 50000)) (PreH8 : (0 <= low_pre)) (PreH9 : (low_pre <= high_pre)) (PreH10 : (high_pre < n)) (PreH11 : (low_pre <= i)) (PreH12 : (i <= j)) (PreH13 : (j <= high_pre)) (PreH14 : (partition_hole_outer_inv l l1 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "low" ) )) # Int  |-> low_pre)
  **  ((( &( "high" ) )) # Int  |-> high_pre)
...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : ((Znth i l1 0) <= pivot)) (PreH2 : (i < j)) (PreH3 : (pivot = (Znth (low_pre) (l) (0)))) (PreH4 : ((Zlength (l)) = n)) (PreH5 : (1 <= n)) (PreH6 : (n <= 50000)) (PreH7 : (0 <= low_pre)) (PreH8 : (low_pre <= high_pre)) (PreH9 : (high_pre < n)) (PreH10 : (low_pre <= i)) (PreH11 : (i <= j)) (PreH12 : (j <= high_pre)) (PreH13 : (partition_hole_left_scan_inv l l1 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "low" ) )) # Int  |-> low_pre)
  **  ((( &( "high" ) )) # Int  |-> high_pre)
...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i >= j)) (PreH2 : ((Znth i l1 0) > pivot)) (PreH3 : (i < j)) (PreH4 : (pivot = (Znth (low_pre) (l) (0)))) (PreH5 : ((Zlength (l)) = n)) (PreH6 : (1 <= n)) (PreH7 : (n <= 50000)) (PreH8 : (0 <= low_pre)) (PreH9 : (low_pre <= high_pre)) (PreH10 : (high_pre < n)) (PreH11 : (low_pre <= i)) (PreH12 : (i <= j)) (PreH13 : (j <= high_pre)) (PreH14 : (partition_hole_left_scan_inv l l1 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "low" ) )) # Int  |-> low_pre)
  **  ((( &( "high" ) )) # Int  |-> high_pre)
...
(
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (PreH1 : ((Zlength (l)) = n)) (PreH2 : (1 <= n)) (PreH3 : (n <= 50000)) (PreH4 : (0 <= low_pre)) (PreH5 : (low_pre <= high_pre)) (PreH6 : (high_pre < n)) ,
...
|--
  ...
  &&  “ (low_pre <= high_pre) ” 
  &&  “ (high_pre <= high_pre) ” 
  &&  “ (partition_hole_outer_inv l l1 low_pre high_pre (Znth low_pre l 0) low_pre high_pre ) ”
  &&  (IntArray.full arr_pre n l1 )
) \/
(
forall (high_pre: Z) (low_pre: Z) (n: Z) (l: (@list Z)) (PreH1 : ((Zlength (l)) = n)) (PreH2 : (1 <= n)) (PreH3 : (n <= 50000)) (PreH4 : (0 <= low_pre)) (PreH5 : (low_pre <= high_pre)) (PreH6 : (high_pre < n)) ,
  TT && emp 
|--
  “ (partition_hole_outer_inv l l low_pre high_pre (Znth low_pre l 0) low_pre high_pre ) ”
  &&  emp
).
...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (pivot = (Znth (low_pre) (l) (0)))) (PreH2 : ((Zlength (l)) = n)) (PreH3 : (1 <= n)) (PreH4 : (n <= 50000)) (PreH5 : (0 <= low_pre)) (PreH6 : (low_pre <= high_pre)) (PreH7 : (high_pre < n)) (PreH8 : (low_pre <= i)) (PreH9 : (i <= j)) (PreH10 : (j <= high_pre)) (PreH11 : (partition_hole_outer_inv l l1_2 low_pre high_pre pivot i j )) ,
...
|--
  ...
  &&  “ (i <= j) ” 
  &&  “ (j <= high_pre) ” 
  &&  “ (partition_hole_outer_inv l l1 low_pre high_pre pivot i j ) ”
  &&  (IntArray.full arr_pre n l1 )
.

Definition partition_entail_wit_3 := 
(
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : ((Znth j l1_2 0) > pivot)) (PreH2 : (i < j)) (PreH3 : (pivot = (Znth (low_pre) (l) (0)))) (PreH4 : ((Zlength (l)) = n)) (PreH5 : (1 <= n)) (PreH6 : (n <= 50000)) (PreH7 : (0 <= low_pre)) (PreH8 : (low_pre <= high_pre)) (PreH9 : (high_pre < n)) (PreH10 : (low_pre <= i)) (PreH11 : (i <= j)) (PreH12 : (j <= high_pre)) (PreH13 : (partition_hole_outer_inv l l1_2 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1_2 )
|--
  EX (l1: (@list Z)) ,
  “ (pivot = (Znth (low_pre) (l) (0))) ” 
  ...
  &&  “ (i <= (j - 1 )) ” 
  &&  “ ((j - 1 ) <= high_pre) ” 
  &&  “ (partition_hole_outer_inv l l1 low_pre high_pre pivot i (j - 1 ) ) ”
  &&  (IntArray.full arr_pre n l1 )
) \/
(
forall (high_pre: Z) (low_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : ((Znth j l1_2 0) > pivot)) (PreH2 : (i < j)) (PreH3 : (pivot = (Znth (low_pre) (l) (0)))) (PreH4 : ((Zlength (l)) = n)) (PreH5 : (1 <= n)) (PreH6 : (n <= 50000)) (PreH7 : (0 <= low_pre)) (PreH8 : (low_pre <= high_pre)) (PreH9 : (high_pre < n)) (PreH10 : (low_pre <= i)) (PreH11 : (i <= j)) (PreH12 : (j <= high_pre)) (PreH13 : (partition_hole_outer_inv l l1_2 low_pre high_pre pivot i j )) ,
  TT && emp 
|--
  “ (partition_hole_outer_inv l l1_2 low_pre high_pre pivot i (j - 1 ) ) ”
  &&  emp
).
...
(
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i < j)) (PreH2 : ((Znth j l1_2 0) <= pivot)) (PreH3 : (i < j)) (PreH4 : (pivot = (Znth (low_pre) (l) (0)))) (PreH5 : ((Zlength (l)) = n)) (PreH6 : (1 <= n)) (PreH7 : (n <= 50000)) (PreH8 : (0 <= low_pre)) (PreH9 : (low_pre <= high_pre)) (PreH10 : (high_pre < n)) (PreH11 : (low_pre <= i)) (PreH12 : (i <= j)) (PreH13 : (j <= high_pre)) (PreH14 : (partition_hole_outer_inv l l1_2 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n (replace_Znth (i) ((Znth j l1_2 0)) (l1_2)) )
|--
  EX (l1: (@list Z)) ,
  “ (pivot = (Znth (low_pre) (l) (0))) ” 
  &&  “ ((Zlength (l)) = n) ” 
  ...
  &&  “ ((i + 1 ) <= j) ” 
  &&  “ (j <= high_pre) ” 
  &&  “ (partition_hole_left_scan_inv l l1 low_pre high_pre pivot (i + 1 ) j ) ”
  &&  (IntArray.full arr_pre n l1 )
) \/
(
forall (high_pre: Z) (low_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i < j)) (PreH2 : ((Znth j l1_2 0) <= pivot)) (PreH3 : (i < j)) (PreH4 : (pivot = (Znth (low_pre) (l) (0)))) (PreH5 : ((Zlength (l)) = n)) (PreH6 : (1 <= n)) (PreH7 : (n <= 50000)) (PreH8 : (0 <= low_pre)) (PreH9 : (low_pre <= high_pre)) (PreH10 : (high_pre < n)) (PreH11 : (low_pre <= i)) (PreH12 : (i <= j)) (PreH13 : (j <= high_pre)) (PreH14 : (partition_hole_outer_inv l l1_2 low_pre high_pre pivot i j )) ,
  TT && emp 
|--
  “ (partition_hole_left_scan_inv l (replace_Znth (i) ((Znth j l1_2 0)) (l1_2)) low_pre high_pre pivot (i + 1 ) j ) ”
  &&  emp
).
...
(
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : ((Znth i l1_2 0) <= pivot)) (PreH2 : (i < j)) (PreH3 : (pivot = (Znth (low_pre) (l) (0)))) (PreH4 : ((Zlength (l)) = n)) (PreH5 : (1 <= n)) (PreH6 : (n <= 50000)) (PreH7 : (0 <= low_pre)) (PreH8 : (low_pre <= high_pre)) (PreH9 : (high_pre < n)) (PreH10 : (low_pre <= i)) (PreH11 : (i <= j)) (PreH12 : (j <= high_pre)) (PreH13 : (partition_hole_left_scan_inv l l1_2 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1_2 )
|--
  EX (l1: (@list Z)) ,
  “ (pivot = (Znth (low_pre) (l) (0))) ” 
...
(
forall (high_pre: Z) (low_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : ((Znth i l1_2 0) <= pivot)) (PreH2 : (i < j)) (PreH3 : (pivot = (Znth (low_pre) (l) (0)))) (PreH4 : ((Zlength (l)) = n)) (PreH5 : (1 <= n)) (PreH6 : (n <= 50000)) (PreH7 : (0 <= low_pre)) (PreH8 : (low_pre <= high_pre)) (PreH9 : (high_pre < n)) (PreH10 : (low_pre <= i)) (PreH11 : (i <= j)) (PreH12 : (j <= high_pre)) (PreH13 : (partition_hole_left_scan_inv l l1_2 low_pre high_pre pivot i j )) ,
  TT && emp 
|--
  “ (partition_hole_left_scan_inv l l1_2 low_pre high_pre pivot (i + 1 ) j ) ”
  &&  emp
).
...
(
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i < j)) (PreH2 : ((Znth i l1_2 0) > pivot)) (PreH3 : (i < j)) (PreH4 : (pivot = (Znth (low_pre) (l) (0)))) (PreH5 : ((Zlength (l)) = n)) (PreH6 : (1 <= n)) (PreH7 : (n <= 50000)) (PreH8 : (0 <= low_pre)) (PreH9 : (low_pre <= high_pre)) (PreH10 : (high_pre < n)) (PreH11 : (low_pre <= i)) (PreH12 : (i <= j)) (PreH13 : (j <= high_pre)) (PreH14 : (partition_hole_left_scan_inv l l1_2 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n (replace_Znth (j) ((Znth i l1_2 0)) (l1_2)) )
|--
  EX (l1: (@list Z)) ,
  “ (pivot = (Znth (low_pre) (l) (0))) ” 
  &&  “ ((Zlength (l)) = n) ” 
...
(
forall (high_pre: Z) (low_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i < j)) (PreH2 : ((Znth i l1_2 0) > pivot)) (PreH3 : (i < j)) (PreH4 : (pivot = (Znth (low_pre) (l) (0)))) (PreH5 : ((Zlength (l)) = n)) (PreH6 : (1 <= n)) (PreH7 : (n <= 50000)) (PreH8 : (0 <= low_pre)) (PreH9 : (low_pre <= high_pre)) (PreH10 : (high_pre < n)) (PreH11 : (low_pre <= i)) (PreH12 : (i <= j)) (PreH13 : (j <= high_pre)) (PreH14 : (partition_hole_left_scan_inv l l1_2 low_pre high_pre pivot i j )) ,
  TT && emp 
|--
  “ (partition_hole_outer_inv l (replace_Znth (j) ((Znth i l1_2 0)) (l1_2)) low_pre high_pre pivot i (j - 1 ) ) ”
  &&  emp
).
...
(
forall (high_pre: Z) (low_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i >= j)) (PreH2 : (i >= j)) (PreH3 : (pivot = (Znth (low_pre) (l) (0)))) (PreH4 : ((Zlength (l)) = n)) (PreH5 : (1 <= n)) (PreH6 : (n <= 50000)) (PreH7 : (0 <= low_pre)) (PreH8 : (low_pre <= high_pre)) (PreH9 : (high_pre < n)) (PreH10 : (low_pre <= i)) (PreH11 : (i <= j)) (PreH12 : (j <= high_pre)) (PreH13 : (partition_hole_outer_inv l l1_2 low_pre high_pre pivot i j )) ,
  TT && emp 
|--
...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i < j)) (PreH2 : (pivot = (Znth (low_pre) (l) (0)))) (PreH3 : ((Zlength (l)) = n)) (PreH4 : (1 <= n)) (PreH5 : (n <= 50000)) (PreH6 : (0 <= low_pre)) (PreH7 : (low_pre <= high_pre)) (PreH8 : (high_pre < n)) (PreH9 : (low_pre <= i)) (PreH10 : (i <= j)) (PreH11 : (j <= high_pre)) (PreH12 : (partition_hole_outer_inv l l1 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1 )
|--
  “ (i < j) ” 
  &&  “ (pivot = (Znth (low_pre) (l) (0))) ” 
...
forall (high_pre: Z) (low_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (j: Z) (i: Z) (pivot: Z) (PreH1 : (i < j)) (PreH2 : (pivot = (Znth (low_pre) (l) (0)))) (PreH3 : ((Zlength (l)) = n)) (PreH4 : (1 <= n)) (PreH5 : (n <= 50000)) (PreH6 : (0 <= low_pre)) (PreH7 : (low_pre <= high_pre)) (PreH8 : (high_pre < n)) (PreH9 : (low_pre <= i)) (PreH10 : (i <= j)) (PreH11 : (j <= high_pre)) (PreH12 : (partition_hole_left_scan_inv l l1 low_pre high_pre pivot i j )) ,
  (IntArray.full arr_pre n l1 )
|--
  “ (i < j) ” 
  &&  “ (pivot = (Znth (low_pre) (l) (0))) ” 
  ...
  &&  “ (i <= j) ” 
  &&  “ (j <= high_pre) ” 
  &&  “ (partition_hole_left_scan_inv l l1 low_pre high_pre pivot i j ) ”
...
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (retval: Z) (PreH1 : (left_pre <= retval)) (PreH2 : (retval <= right_pre)) (PreH3 : (Permutation l l1 )) (PreH4 : (same_outside_range l l1 left_pre right_pre )) (PreH5 : (partitioned_at l1 left_pre right_pre retval )) (PreH6 : ((Zlength (l)) = n)) (PreH7 : (0 <= n)) (PreH8 : (n <= 50000)) (PreH9 : (0 <= left_pre)) (PreH10 : (left_pre <= right_pre)) (PreH11 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
...
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (retval: Z) (PreH1 : (retval < (right_pre - 1 ))) (PreH2 : (retval <= (left_pre + 1 ))) (PreH3 : (left_pre <= retval)) (PreH4 : (retval <= right_pre)) (PreH5 : (Permutation l l1 )) (PreH6 : (same_outside_range l l1 left_pre right_pre )) (PreH7 : (partitioned_at l1 left_pre right_pre retval )) (PreH8 : ((Zlength (l)) = n)) (PreH9 : (0 <= n)) (PreH10 : (n <= 50000)) (PreH11 : (0 <= left_pre)) (PreH12 : (left_pre <= right_pre)) (PreH13 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) (l1_4: (@list Z)) (PreH1 : (Permutation l1_3 l1_4 )) (PreH2 : (same_outside_range l1_3 l1_4 (retval + 1 ) right_pre )) (PreH3 : (range_nondecreasing l1_4 (retval + 1 ) right_pre )) (PreH4 : (retval < (right_pre - 1 ))) (PreH5 : (Permutation l1_2 l1_3 )) (PreH6 : (same_outside_range l1_2 l1_3 left_pre (retval - 1 ) )) (PreH7 : (range_nondecreasing l1_3 left_pre (retval - 1 ) )) (PreH8 : (retval > (left_pre + 1 ))) (PreH9 : (left_pre <= retval)) (PreH10 : (retval <= right_pre)) (PreH11 : (Permutation l l1_2 )) (PreH12 : (same_outside_range l l1_2 left_pre right_pre )) (PreH13 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH14 : ((Zlength (l)) = n)) (PreH15 : (0 <= n)) (PreH16 : (n <= 50000)) (PreH17 : (0 <= left_pre)) (PreH18 : (left_pre <= right_pre)) (PreH19 : (right_pre < n)) ,
  TT && emp 
|--
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) (PreH1 : (Permutation l1_2 l1_3 )) (PreH2 : (same_outside_range l1_2 l1_3 (retval + 1 ) right_pre )) (PreH3 : (range_nondecreasing l1_3 (retval + 1 ) right_pre )) (PreH4 : (retval < (right_pre - 1 ))) (PreH5 : (retval <= (left_pre + 1 ))) (PreH6 : (left_pre <= retval)) (PreH7 : (retval <= right_pre)) (PreH8 : (Permutation l l1_2 )) (PreH9 : (same_outside_range l l1_2 left_pre right_pre )) (PreH10 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH11 : ((Zlength (l)) = n)) (PreH12 : (0 <= n)) (PreH13 : (n <= 50000)) (PreH14 : (0 <= left_pre)) (PreH15 : (left_pre <= right_pre)) (PreH16 : (right_pre < n)) ,
  TT && emp 
|--
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) (PreH1 : (retval >= (right_pre - 1 ))) (PreH2 : (Permutation l1_2 l1_3 )) (PreH3 : (same_outside_range l1_2 l1_3 left_pre (retval - 1 ) )) (PreH4 : (range_nondecreasing l1_3 left_pre (retval - 1 ) )) (PreH5 : (retval > (left_pre + 1 ))) (PreH6 : (left_pre <= retval)) (PreH7 : (retval <= right_pre)) (PreH8 : (Permutation l l1_2 )) (PreH9 : (same_outside_range l l1_2 left_pre right_pre )) (PreH10 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH11 : ((Zlength (l)) = n)) (PreH12 : (0 <= n)) (PreH13 : (n <= 50000)) (PreH14 : (0 <= left_pre)) (PreH15 : (left_pre <= right_pre)) (PreH16 : (right_pre < n)) ,
  TT && emp 
|--
  “ (range_nondecreasing l1_3 left_pre right_pre ) ” 
  &&  “ (same_outside_range l l1_3 left_pre right_pre ) ” 
...
(
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (PreH1 : (retval >= (right_pre - 1 ))) (PreH2 : (retval <= (left_pre + 1 ))) (PreH3 : (left_pre <= retval)) (PreH4 : (retval <= right_pre)) (PreH5 : (Permutation l l1_2 )) (PreH6 : (same_outside_range l l1_2 left_pre right_pre )) (PreH7 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH8 : ((Zlength (l)) = n)) (PreH9 : (0 <= n)) (PreH10 : (n <= 50000)) (PreH11 : (0 <= left_pre)) (PreH12 : (left_pre <= right_pre)) (PreH13 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1_2 )
|--
  EX (l1: (@list Z)) ,
  “ (Permutation l l1 ) ” 
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (PreH1 : (retval >= (right_pre - 1 ))) (PreH2 : (retval <= (left_pre + 1 ))) (PreH3 : (left_pre <= retval)) (PreH4 : (retval <= right_pre)) (PreH5 : (Permutation l l1_2 )) (PreH6 : (same_outside_range l l1_2 left_pre right_pre )) (PreH7 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH8 : ((Zlength (l)) = n)) (PreH9 : (0 <= n)) (PreH10 : (n <= 50000)) (PreH11 : (0 <= left_pre)) (PreH12 : (left_pre <= right_pre)) (PreH13 : (right_pre < n)) ,
  TT && emp 
|--
...
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (PreH1 : ((Zlength (l)) = n)) (PreH2 : (0 <= n)) (PreH3 : (n <= 50000)) (PreH4 : (0 <= left_pre)) (PreH5 : (left_pre <= right_pre)) (PreH6 : (right_pre < n)) ,
  ((( &( "p" ) )) # Int  |->_)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
  **  ((( &( "right" ) )) # Int  |-> right_pre)
...
(
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (retval: Z) (PreH1 : (right_pre <= INT_MAX)) (PreH2 : (left_pre <= INT_MAX)) (PreH3 : (retval <= INT_MAX)) (PreH4 : (right_pre >= INT_MIN)) (PreH5 : (left_pre >= INT_MIN)) (PreH6 : (retval >= INT_MIN)) (PreH7 : (retval > (left_pre + 1 ))) (PreH8 : (left_pre <= retval)) (PreH9 : (retval <= right_pre)) (PreH10 : (Permutation l l1 )) (PreH11 : (same_outside_range l l1 left_pre right_pre )) (PreH12 : (partitioned_at l1 left_pre right_pre retval )) (PreH13 : ((Zlength (l)) = n)) (PreH14 : (0 <= n)) (PreH15 : (n <= 50000)) (PreH16 : (0 <= left_pre)) (PreH17 : (left_pre <= right_pre)) (PreH18 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
...
(
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1: (@list Z)) (PreH1 : (retval < (right_pre - 1 ))) (PreH2 : (Permutation l1_2 l1 )) (PreH3 : (same_outside_range l1_2 l1 left_pre (retval - 1 ) )) (PreH4 : (range_nondecreasing l1 left_pre (retval - 1 ) )) (PreH5 : (retval > (left_pre + 1 ))) (PreH6 : (left_pre <= retval)) (PreH7 : (retval <= right_pre)) (PreH8 : (Permutation l l1_2 )) (PreH9 : (same_outside_range l l1_2 left_pre right_pre )) (PreH10 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH11 : ((Zlength (l)) = n)) (PreH12 : (0 <= n)) (PreH13 : (n <= 50000)) (PreH14 : (0 <= left_pre)) (PreH15 : (left_pre <= right_pre)) (PreH16 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
...
(
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1: (@list Z)) (PreH1 : (right_pre <= INT_MAX)) (PreH2 : (left_pre <= INT_MAX)) (PreH3 : (retval <= INT_MAX)) (PreH4 : (right_pre >= INT_MIN)) (PreH5 : (left_pre >= INT_MIN)) (PreH6 : (retval >= INT_MIN)) (PreH7 : (retval < (right_pre - 1 ))) (PreH8 : (Permutation l1_2 l1 )) (PreH9 : (same_outside_range l1_2 l1 left_pre (retval - 1 ) )) (PreH10 : (range_nondecreasing l1 left_pre (retval - 1 ) )) (PreH11 : (retval > (left_pre + 1 ))) (PreH12 : (left_pre <= retval)) (PreH13 : (retval <= right_pre)) (PreH14 : (Permutation l l1_2 )) (PreH15 : (same_outside_range l l1_2 left_pre right_pre )) (PreH16 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH17 : ((Zlength (l)) = n)) (PreH18 : (0 <= n)) (PreH19 : (n <= 50000)) (PreH20 : (0 <= left_pre)) (PreH21 : (left_pre <= right_pre)) (PreH22 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
...
(
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (retval: Z) (PreH1 : (right_pre <= INT_MAX)) (PreH2 : (left_pre <= INT_MAX)) (PreH3 : (retval <= INT_MAX)) (PreH4 : (right_pre >= INT_MIN)) (PreH5 : (left_pre >= INT_MIN)) (PreH6 : (retval >= INT_MIN)) (PreH7 : (retval < (right_pre - 1 ))) (PreH8 : (retval <= (left_pre + 1 ))) (PreH9 : (left_pre <= retval)) (PreH10 : (retval <= right_pre)) (PreH11 : (Permutation l l1 )) (PreH12 : (same_outside_range l l1 left_pre right_pre )) (PreH13 : (partitioned_at l1 left_pre right_pre retval )) (PreH14 : ((Zlength (l)) = n)) (PreH15 : (0 <= n)) (PreH16 : (n <= 50000)) (PreH17 : (0 <= left_pre)) (PreH18 : (left_pre <= right_pre)) (PreH19 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
...
Definition quicksort_return_wit_1_split_goal_2 := 
forall (n_pre: Z) (l: (@list Z)) (l1_2: (@list Z)) (PreH1 : (Permutation l l1_2 )) (PreH2 : (same_outside_range l l1_2 0 (n_pre - 1 ) )) (PreH3 : (range_nondecreasing l1_2 0 (n_pre - 1 ) )) (PreH4 : (n_pre > 0)) (PreH5 : ((Zlength (l)) = n_pre)) (PreH6 : (0 <= n_pre)) (PreH7 : (n_pre <= 50000)) ,
  (increasing l1_2 )
.
