...
Proof.
  unfold mpn_submul_1_entail_wit_1.
  left.
  intros vl_pre n_pre up_pre rp_pre l_up l_rp
...
Proof.
  unfold mpn_submul_1_entail_wit_5_1.
  left.
  intros.
...
Proof.
  unfold mpn_submul_1_entail_wit_5_2.
  left.
  intros.
  pose proof (unsigned_Lastnbits_range (lpl + cl) 32 ltac:(lia)) as Hlo_range.
  pose proof (unsigned_Lastnbits_range
...
Proof.
  unfold mpn_submul_1_entail_wit_5_3.
  left.
  intros.
  pose proof (unsigned_Lastnbits_range (lpl + cl) 32 ltac:(lia)) as Hlo_range.
  pose proof (unsigned_Lastnbits_range
...
Proof.
  unfold mpn_submul_1_entail_wit_5_4.
  left.
  intros.
  pose proof (unsigned_Lastnbits_range (lpl + cl) 32 ltac:(lia)) as Hlo_range.
  pose proof (unsigned_Lastnbits_range
...
Proof.
  unfold mpn_submul_1_return_wit_1.
  left.
  intros vl_pre n_pre up_pre rp_pre l_up l_rp l_done cl i
  ...
  - rewrite Zsublist_nil by lia.
    ...
    lia.
  - Intros.
    rewrite Hi in PreH14.
    rewrite (sublist_self l_rp n_pre) in PreH14 by lia.
    rewrite (sublist_self l_up n_pre) in PreH14 by lia.
    entailer!.
Qed.
