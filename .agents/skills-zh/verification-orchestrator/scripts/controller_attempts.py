...
def _group_tooling(
    ...
    return {
        "target_file": Path(".coq_group_checks") / f"{case['case_name']}_{coq_group_name}_check.v",
        "build_workspace": build,
        "group_check": {
            "case_theory": case["active_theory"],
            "require_modules": [
                case["case_name"] + "_goal",
                case["case_name"] + "_proof_auto",
                case["case_name"] + "_proof_manual",
            ],
