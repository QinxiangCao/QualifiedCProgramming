...
(
forall (zb_neq: Z) (za_neq: Z) (aptr: Z) (a_size: Z) (acap: Z) (bptr: Z) (b_size: Z) (bcap: Z) (PreH1 : (a_size < b_size)) (PreH2 : (a_size <> b_size)) (PreH3 : (same_sign za_neq a_size )) (PreH4 : ((Zabs (a_size)) <= acap)) (PreH5 : (same_sign zb_neq b_size )) (PreH6 : ((Zabs (b_size)) <= bcap)) ,
  (mpd_store_Z_compact UINT_MOD aptr (Zabs (za_neq)) (Zabs (a_size)) )
  **  (mpd_store_Z_compact UINT_MOD bptr (Zabs (zb_neq)) (Zabs (b_size)) )
|--
  “ (za_neq < zb_neq) ”
...
Definition mpz_cmp_return_wit_7_split_goal_spatial := 
forall (zb_neq: Z) (za_neq: Z) (aptr: Z) (a_size: Z) (acap: Z) (bptr: Z) (b_size: Z) (bcap: Z) (PreH1 : (a_size < b_size)) (PreH2 : (a_size <> b_size)) (PreH3 : (same_sign za_neq a_size )) (PreH4 : ((Zabs (a_size)) <= acap)) (PreH5 : (same_sign zb_neq b_size )) (PreH6 : ((Zabs (b_size)) <= bcap)) ,
  (mpd_store_Z_compact UINT_MOD aptr (Zabs (za_neq)) (Zabs (a_size)) )
  **  (mpd_store_Z_compact UINT_MOD bptr (Zabs (zb_neq)) (Zabs (b_size)) )
|--
...
Definition mpz_cmp_return_wit_8_split_goal_spatial := 
forall (zb_neq: Z) (za_neq: Z) (aptr: Z) (a_size: Z) (acap: Z) (bptr: Z) (b_size: Z) (bcap: Z) (PreH1 : (a_size >= b_size)) (PreH2 : (a_size <> b_size)) (PreH3 : (same_sign za_neq a_size )) (PreH4 : ((Zabs (a_size)) <= acap)) (PreH5 : (same_sign zb_neq b_size )) (PreH6 : ((Zabs (b_size)) <= bcap)) ,
  (mpd_store_Z_compact UINT_MOD aptr (Zabs (za_neq)) (Zabs (a_size)) )
  **  (mpd_store_Z_compact UINT_MOD bptr (Zabs (zb_neq)) (Zabs (b_size)) )
|--
