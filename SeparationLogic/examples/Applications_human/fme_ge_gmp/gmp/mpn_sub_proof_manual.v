...
Lemma proof_of_mpn_sub_partial_solve_wit_5_rp_eq_bp_pure : mpn_sub_partial_solve_wit_5_rp_eq_bp_pure.
Proof.
  unfold mpn_sub_partial_solve_wit_5_rp_eq_bp_pure.
  right.
  intros.
  subst.
...
Proof.
  unfold mpn_sub_entail_wit_3_rp_eq_bp.
  left.
  intros.
  Exists val_r.
...
Proof.
  unfold mpn_sub_entail_wit_9_1_rp_eq_bp.
  left.
  intros.
...
Proof.
  unfold mpn_sub_entail_wit_9_2_rp_eq_bp.
  left.
  intros.
  Exists val_r_low.
  unfold mpd_store_Z, mpd_store_list.
...
Proof.
  unfold mpn_sub_entail_wit_10_1_rp_eq_ap.
  left.
  intros.
  Exists (val_r_low + val' * Z.pow UINT_MOD bn_pre).
  unfold mpd_store_Z, mpd_store_list.
...
Proof.
  unfold mpn_sub_entail_wit_10_2_rp_eq_ap.
  left.
  intros.
  Exists val_r_low.
  unfold mpd_store_Z, mpd_store_list.
...
Proof.
  unfold mpn_sub_return_wit_2_rp_eq_ap.
  right.
  intros.
  Exists val_r_out_2.
  replace ap_pre with rp_pre by lia.
...
Proof.
  unfold mpn_sub_which_implies_wit_1.
  left.
  intros.
  unfold mpd_store_Z, mpd_store_list.
  Intros data.
...
Proof.
  unfold mpn_sub_which_implies_wit_2.
  left.
  intros.
  unfold mpd_store_Z, mpd_store_list.
  Intros data.
