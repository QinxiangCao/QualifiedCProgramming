...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_1_1.
  left.
  intros.
  ...
  -
    ...
    cancel.
    split_pure_spatial; [cancel | apply derivable1s_coq_prop_r; reflexivity].
  -
    split_pures.
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_1_2.
  left.
  intros.
  Exists (n1_pre * UINT_MOD ^ nn_pre + list_to_Z UINT_MOD l_np_bare) 0 (@nil Z) l_np_bare.
  split_pure_spatial.
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_2_1.
  left.
  intros.
  ...
  -
    split_pures.
    all: try (apply derivable1s_coq_prop_r; subst;
              rewrite ?Zlength_sublist, ?PreH9; try lia; try ring;
              try assumption; try reflexivity).
    all: try (apply derivable1s_coq_prop_r; eapply list_within_bound_sublist;
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_2_2.
  left.
  intros.
  Exists remv_2 qv_done_2
    (sublist (i + dn0_bare) nn0_bare l_cur_2)
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_4_4.
  left.
  intros.
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_4_3.
  left.
  intros.
  Exists remv_2 n1 qv_done_2
    (sublist (dn0_bare - 2) dn0_bare l_dp_bare)
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_4_2.
  left.
  intros.
  Exists remv_2 n1 qv_done_2
    (sublist (dn0_bare - 2) dn0_bare l_dp_bare)
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_4_1.
  left.
  intros.
  Exists remv_2 n1 qv_done_2
    (sublist (dn0_bare - 2) dn0_bare l_dp_bare)
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_6_1.
  left.
  intros.
  ...
  - split_pures.
    all: try (apply derivable1s_coq_prop_r; assumption).
    all: try (apply derivable1s_coq_prop_r; reflexivity).
    apply derivable1s_coq_prop_r; clear -PreH22; lia.
    apply derivable1s_coq_prop_r.
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_6_2.
  left.
  intros.
  set (l_repl := replace_Znth 0 (unsigned_last_nbits (n0 - retval) 32) l_mid_high_2).
  assert (Hlrepl_len : Zlength l_repl = 2).
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_1.
  left.
  intros.
  ...
  - replace (i - 1 + 1) with i by lia.
      ...
      * simpl.
        ...
        cancel.
  - split_pures.
    + apply derivable1s_coq_prop_r; exact PreH20.
    + apply derivable1s_coq_prop_r; exact PreH21.
    + apply derivable1s_coq_prop_r; exact PreH22.
    + apply derivable1s_coq_prop_r; exact PreH23.
    + apply derivable1s_coq_prop_r; exact PreH24.
    + apply derivable1s_coq_prop_r; lia.
    + apply derivable1s_coq_prop_r; lia.
    + apply derivable1s_coq_prop_r.
      rewrite !Zlength_app, PreH33, PreH1, PreH35; lia.
    + apply derivable1s_coq_prop_r; exact PreH28.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r; exact PreH37.
    + apply derivable1s_coq_prop_r.
      simpl.
      split.
      * unfold UINT_MOD; lia.
      * exact PreH38.
    + apply derivable1s_coq_prop_r; exact PreH42.
    + apply derivable1s_coq_prop_r.
      rewrite list_to_Z_cons, PreH43.
      unfold UINT_MOD; ring.
    + apply derivable1s_coq_prop_r; exact PreH44.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r; exact PreH47.
    + apply derivable1s_coq_prop_r; exact PreH48.
    + apply derivable1s_coq_prop_r; exact PreH49.
    + apply derivable1s_coq_prop_r; exact PreH50.
    + apply derivable1s_coq_prop_r; exact PreH51.
    + apply derivable1s_coq_prop_r; exact PreH52.
    + apply derivable1s_coq_prop_r; exact PreH53.
    + apply derivable1s_coq_prop_r; exact PreH54.
    + apply derivable1s_coq_prop_r; reflexivity.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      unfold UINT_MOD.
      ring.
    + apply derivable1s_coq_prop_r; exact PreH60.
Qed. 

Lemma proof_of_mpn_div_qr_pi1_entail_wit_9_2 : mpn_div_qr_pi1_entail_wit_9_2.
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_2.
  left.
  intros.
  ...
  assert (Hretval_nonneg : 0 <= retval).
  {
    ...
    assert (Hright_nonneg : 0 <= val_np_add + val_dp_add) by (clear -Hnpadd_nonneg Hdp_nonneg; lia).
  ...
  assert (Hretval_le1 : retval <= 1).
  {
    ...
    assert (Hright_lt : val_np_add + val_dp_add < 2 * P) by (clear -Hnpadd_lt Hdp_lt; lia).
  ...
  pose proof (mpn_div_qr_pi1_addback_transition
    ...
    PreH43 PreH44 PreH48 PreH49 PreH52 Hdata_np_val PreH53 PreH54 PreH1 PreH55
  ...
  - replace (i - 1 + 1) with i by lia.
    ...
    { apply derivable1s_coq_prop_r. clear -PreH9 PreH10. lia. }
    simpl.
    ...
    { apply derivable1s_coq_prop_r. clear -PreH4. lia. }
    rewrite PreH86.
    sep_apply_l_atomic (UIntArray.seg_to_full np0_bare 0 i l_low).
    replace (np0_bare + 0 * sizeof(UINT)) with np0_bare by lia.
    replace (i - 0) with i by ring.
    ...
    { apply derivable1s_coq_prop_r. clear -PreH4 PreH9. lia. }
    sep_apply_l_atomic (UIntArray.seg_to_full np0_bare (i + dn0_bare) nn0_bare l_high).
    replace (nn0_bare - (i + dn0_bare)) with (nn0_bare - (i + dn0_bare)) by ring.
    sep_apply_l_atomic
      (UIntArray.full_merge_to_full np0_bare (i + dn0_bare) nn0_bare (l_low ++ data_np ++ l_np_tail) l_high).
    { apply derivable1s_coq_prop_r. clear -PreH4 PreH9 PreH10. lia. }
    rewrite app_assoc.
    subst data_dp.
    ...
    cancel.
  - split_pures.
    + apply derivable1s_coq_prop_r; exact PreH2.
    + apply derivable1s_coq_prop_r; exact PreH3.
    + apply derivable1s_coq_prop_r; exact PreH4.
    + apply derivable1s_coq_prop_r; exact PreH7.
    + apply derivable1s_coq_prop_r; exact PreH8.
    + apply derivable1s_coq_prop_r. clear -PreH9. lia.
    + apply derivable1s_coq_prop_r. clear -PreH10. lia.
    + apply derivable1s_coq_prop_r.
      rewrite !Zlength_app, PreH25, Hdata_np_len, PreH34, PreH27. clear. lia.
    + apply derivable1s_coq_prop_r; exact PreH12.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r; exact PreH38.
    + apply derivable1s_coq_prop_r.
      simpl; split.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      ring.
    + apply derivable1s_coq_prop_r; exact PreH56.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      change (2 ^ 32) with UINT_MOD in Hrange.
      unfold UINT_MOD in *; lia.
    + apply derivable1s_coq_prop_r; exact PreH71.
    + apply derivable1s_coq_prop_r; exact PreH72.
    + apply derivable1s_coq_prop_r; exact PreH73.
    + apply derivable1s_coq_prop_r; exact PreH74.
    + apply derivable1s_coq_prop_r; exact PreH75.
    + apply derivable1s_coq_prop_r; exact PreH76.
    + apply derivable1s_coq_prop_r; exact PreH77.
    + apply derivable1s_coq_prop_r; exact PreH78.
    + apply derivable1s_coq_prop_r; reflexivity.
    + apply derivable1s_coq_prop_r; exact Hrem_nonneg.
    + apply derivable1s_coq_prop_r.
      replace (i - 1 + 1) with i by lia.
      exact Hrem_lt.
    + apply derivable1s_coq_prop_r.
      ...
      rewrite Hpow.
      ring.
    + apply derivable1s_coq_prop_r; exact PreH87.
Qed. 

Lemma proof_of_mpn_div_qr_pi1_entail_wit_9_3 : mpn_div_qr_pi1_entail_wit_9_3.
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_3.
  left.
  intros.
  ...
  - replace (dn0_bare - 2 - (dn0_bare - 2)) with 0 by ring.
    ...
    { apply derivable1s_coq_prop_r. clear -PreH26. lia. }
    simpl.
    sep_apply_l_atomic (UIntArray.seg_to_full np0_bare 0 i l_low).
    replace (np0_bare + 0 * sizeof(UINT)) with np0_bare by lia.
    replace (i - 0) with i by ring.
    ...
    { apply derivable1s_coq_prop_r. clear -PreH22 PreH25. lia. }
    sep_apply_l_atomic (UIntArray.seg_to_full np0_bare (i + dn0_bare) nn0_bare l_high).
    replace (nn0_bare - (i + dn0_bare)) with (nn0_bare - (i + dn0_bare)) by ring.
    sep_apply_l_atomic (UIntArray.full_merge_to_full np0_bare (i + dn0_bare) nn0_bare (l_low ++ l_out ++ l_repl) l_high).
    { apply derivable1s_coq_prop_r. clear -PreH22 PreH25 PreH26. lia. }
    rewrite app_assoc.
  ...
  - split_pures.
    ...
    + apply derivable1s_coq_prop_r; exact PreH23.
    + apply derivable1s_coq_prop_r; exact PreH24.
    + apply derivable1s_coq_prop_r. clear -PreH25. lia.
    + apply derivable1s_coq_prop_r. clear -PreH26. lia.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r; exact PreH45.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      unfold UINT_MOD; ring.
    + apply derivable1s_coq_prop_r; exact PreH56.
    + apply derivable1s_coq_prop_r. clear -PreH61. lia.
    + apply derivable1s_coq_prop_r. clear -PreH62. lia.
    + apply derivable1s_coq_prop_r; exact PreH65.
    + apply derivable1s_coq_prop_r; exact PreH66.
    + apply derivable1s_coq_prop_r; exact PreH67.
    + apply derivable1s_coq_prop_r; exact PreH68.
    + apply derivable1s_coq_prop_r; exact PreH69.
    + apply derivable1s_coq_prop_r; exact PreH70.
    + apply derivable1s_coq_prop_r; exact PreH71.
    + apply derivable1s_coq_prop_r; exact PreH72.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      rewrite Hpow.
      ring.
    + apply derivable1s_coq_prop_r; exact PreH81.
Qed. 

Lemma proof_of_mpn_div_qr_pi1_entail_wit_9_4 : mpn_div_qr_pi1_entail_wit_9_4.
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_4.
  left.
  intros.
  ...
  - split_pures.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      unfold UINT_MOD; ring.
    + apply derivable1s_coq_prop_r; exact PreH56.
    + apply derivable1s_coq_prop_r. clear -PreH1. lia.
    + apply derivable1s_coq_prop_r. clear -PreH1 PreH62. lia.
    + apply derivable1s_coq_prop_r; exact PreH65.
    + apply derivable1s_coq_prop_r; exact PreH66.
    + apply derivable1s_coq_prop_r; exact PreH67.
    + apply derivable1s_coq_prop_r; exact PreH68.
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_5.
  left.
  intros.
  Exists (Znth (dn0_bare - 1) l_out 0 * UINT_MOD ^ (dn0_bare + (i - 1)) +
          list_to_Z UINT_MOD (sublist 0 (dn0_bare + (i - 1)) (l_low ++ l_out ++ l_high))).
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_6.
  left.
  intros.
  unfold mpd_store_Z, mpd_store_list.
  Intros data_np data_dp.
  ...
  pose proof (mpn_div_qr_pi1_addback_transition
    ...
    PreH44 PreH45 PreH49 PreH50 PreH53 Hdata_np_val PreH54 PreH55 PreH1 PreH56
  ...
  - simpl.
    ...
    sep_lift_L ((UIntArray.full np_i (dn0_bare - 1) data_np) ::
      (UIntArray.full (np_i + (dn0_bare - 1) * sizeof(UINT))
        (dn0_bare - (dn0_bare - 1)) l_np_tail) :: nil).
    sep_apply_l_atomic (UIntArray.full_merge_to_full np_i (dn0_bare - 1) dn0_bare data_np l_np_tail).
    { apply derivable1s_coq_prop_r. clear -PreH5. lia. }
    rewrite PreH87.
    sep_apply_l_atomic (UIntArray.seg_to_full np0_bare 0 i l_low).
    replace (np0_bare + 0 * sizeof(UINT)) with np0_bare by lia.
    replace (i - 0) with i by ring.
    ...
    sep_apply_l_atomic
      (UIntArray.full_merge_to_full np0_bare i (i + dn0_bare) l_low (data_np ++ l_np_tail)).
    { apply derivable1s_coq_prop_r. clear -PreH5 PreH10. lia. }
    sep_apply_l_atomic (UIntArray.seg_to_full np0_bare (i + dn0_bare) nn0_bare l_high).
    replace (nn0_bare - (i + dn0_bare)) with (nn0_bare - (i + dn0_bare)) by ring.
    sep_apply_l_atomic
      (UIntArray.full_merge_to_full np0_bare (i + dn0_bare) nn0_bare (l_low ++ data_np ++ l_np_tail) l_high).
    { apply derivable1s_coq_prop_r. clear -PreH5 PreH10 PreH11. lia. }
    rewrite app_assoc.
    subst data_dp.
    replace (UIntArray.full dp0_bare (Zlength l_dp_add) l_dp_add) with
      (UIntArray.full dp0_bare (dn0_bare - 1) l_dp_add) by (f_equal; lia).
  ...
  - split_pures.
    ...
    + apply derivable1s_coq_prop_r; exact PreH8.
    + apply derivable1s_coq_prop_r; exact PreH9.
    + apply derivable1s_coq_prop_r. clear -PreH10. lia.
    + apply derivable1s_coq_prop_r. clear -PreH11. lia.
    + apply derivable1s_coq_prop_r.
      rewrite !Zlength_app, PreH26, Hdata_np_len, PreH35, PreH28. clear. lia.
    + apply derivable1s_coq_prop_r; exact PreH13.
    + apply derivable1s_coq_prop_r.
    ...
    + apply derivable1s_coq_prop_r; exact PreH39.
    + apply derivable1s_coq_prop_r.
      simpl; split.
      * pose proof (unsigned_Lastnbits_range (q - 1) 32 ltac:(lia)) as Hrange.
        change (2 ^ 32) with UINT_MOD in Hrange.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      ring.
    + apply derivable1s_coq_prop_r; exact PreH57.
    + apply derivable1s_coq_prop_r.
      pose proof (unsigned_Lastnbits_range (unsigned_last_nbits (n1 + d1) 32 + retval) 32 ltac:(lia)) as Hrange.
      change (2 ^ 32) with UINT_MOD in Hrange.
      unfold UINT_MOD in *; lia.
    ...
    + apply derivable1s_coq_prop_r; exact PreH77.
    + apply derivable1s_coq_prop_r; exact PreH78.
    + apply derivable1s_coq_prop_r; exact PreH79.
    + apply derivable1s_coq_prop_r; reflexivity.
    + apply derivable1s_coq_prop_r; exact Hrem_nonneg.
    + apply derivable1s_coq_prop_r.
      replace (i - 1 + 1) with i by lia.
    ...
    + apply derivable1s_coq_prop_r.
      ...
      rewrite Hpow.
      ring.
    + apply derivable1s_coq_prop_r; exact PreH88.
Qed. 

Lemma proof_of_mpn_div_qr_pi1_entail_wit_9_7 : mpn_div_qr_pi1_entail_wit_9_7.
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_7.
  left.
  intros.
  set (l_repl := replace_Znth 0 (n0 - retval) l_mid_high).
  assert (Hlrepl_len : Zlength l_repl = 2).
...
Proof.
  unfold mpn_div_qr_pi1_entail_wit_9_8.
  left.
  intros.
  assert (Hborrow_eq : unsigned_last_nbits (n0 - retval) 32 = n0 + UINT_MOD - retval).
  { rewrite (u32_sub_borrow_eq n0 retval); try (unfold UINT_MOD in *; lia). }
...
Proof.
  unfold mpn_div_qr_pi1_return_wit_1.
  left.
  intros.
  Exists remv qv_done
...
Proof.
  unfold mpn_div_qr_pi1_return_wit_2.
  left.
  intros.
  Exists remv qv_done
    (sublist dn0_bare nn0_bare (replace_Znth (dn0_bare - 1) n1 l_cur))
...
Lemma proof_of_mpn_div_qr_pi1_partial_solve_wit_15_pure : mpn_div_qr_pi1_partial_solve_wit_15_pure.
Proof.
  unfold mpn_div_qr_pi1_partial_solve_wit_15_pure.
  right.
  intros.
  split_pures.
  - dump_pre_spatial.
...
Lemma proof_of_mpn_div_qr_pi1_partial_solve_wit_16_pure : mpn_div_qr_pi1_partial_solve_wit_16_pure.
Proof.
  unfold mpn_div_qr_pi1_partial_solve_wit_16_pure.
  right.
  intros.
  split_pures.
  - dump_pre_spatial.
...
Lemma proof_of_mpn_div_qr_pi1_partial_solve_wit_17_pure : mpn_div_qr_pi1_partial_solve_wit_17_pure.
Proof.
  unfold mpn_div_qr_pi1_partial_solve_wit_17_pure.
  right.
  intros.
  split_pures.
  - dump_pre_spatial.
  ...
  - dump_pre_spatial.
    ...
    apply (mpn_div_qr_pi1_trial_lt_eq_high
             n1 d1 (Znth (dn0_bare - 1) l_mid 0) d0).
    + lia.
    + unfold UINT_MOD in *; lia.
    + exact PreH43.
...
Lemma proof_of_mpn_div_qr_pi1_partial_solve_wit_18_pure : mpn_div_qr_pi1_partial_solve_wit_18_pure.
Proof.
  unfold mpn_div_qr_pi1_partial_solve_wit_18_pure.
  right.
  intros.
  split_pures.
  - dump_pre_spatial.
