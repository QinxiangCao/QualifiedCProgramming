...
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1: (@list Z)) (retval: Z) (PreH1 : (retval < right_pre)) (PreH2 : (retval <= left_pre)) (PreH3 : (left_pre <= retval)) (PreH4 : (retval <= right_pre)) (PreH5 : (Permutation l l1 )) (PreH6 : (same_outside_range l l1 left_pre right_pre )) (PreH7 : (partitioned_at l1 left_pre right_pre retval )) (PreH8 : ((Zlength (l)) = n)) (PreH9 : (0 <= n)) (PreH10 : (n <= 50000)) (PreH11 : (0 <= left_pre)) (PreH12 : (left_pre <= right_pre)) (PreH13 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) (l1_4: (@list Z)) (PreH1 : (Permutation l1_3 l1_4 )) (PreH2 : (same_outside_range l1_3 l1_4 (retval + 1 ) right_pre )) (PreH3 : (range_nondecreasing l1_4 (retval + 1 ) right_pre )) (PreH4 : (retval < right_pre)) (PreH5 : (Permutation l1_2 l1_3 )) (PreH6 : (same_outside_range l1_2 l1_3 left_pre (retval - 1 ) )) (PreH7 : (range_nondecreasing l1_3 left_pre (retval - 1 ) )) (PreH8 : (retval > left_pre)) (PreH9 : (left_pre <= retval)) (PreH10 : (retval <= right_pre)) (PreH11 : (Permutation l l1_2 )) (PreH12 : (same_outside_range l l1_2 left_pre right_pre )) (PreH13 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH14 : ((Zlength (l)) = n)) (PreH15 : (0 <= n)) (PreH16 : (n <= 50000)) (PreH17 : (0 <= left_pre)) (PreH18 : (left_pre <= right_pre)) (PreH19 : (right_pre < n)) ,
  TT && emp 
|--
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) (PreH1 : (Permutation l1_2 l1_3 )) (PreH2 : (same_outside_range l1_2 l1_3 (retval + 1 ) right_pre )) (PreH3 : (range_nondecreasing l1_3 (retval + 1 ) right_pre )) (PreH4 : (retval < right_pre)) (PreH5 : (retval <= left_pre)) (PreH6 : (left_pre <= retval)) (PreH7 : (retval <= right_pre)) (PreH8 : (Permutation l l1_2 )) (PreH9 : (same_outside_range l l1_2 left_pre right_pre )) (PreH10 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH11 : ((Zlength (l)) = n)) (PreH12 : (0 <= n)) (PreH13 : (n <= 50000)) (PreH14 : (0 <= left_pre)) (PreH15 : (left_pre <= right_pre)) (PreH16 : (right_pre < n)) ,
  TT && emp 
|--
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) (PreH1 : (retval >= right_pre)) (PreH2 : (Permutation l1_2 l1_3 )) (PreH3 : (same_outside_range l1_2 l1_3 left_pre (retval - 1 ) )) (PreH4 : (range_nondecreasing l1_3 left_pre (retval - 1 ) )) (PreH5 : (retval > left_pre)) (PreH6 : (left_pre <= retval)) (PreH7 : (retval <= right_pre)) (PreH8 : (Permutation l l1_2 )) (PreH9 : (same_outside_range l l1_2 left_pre right_pre )) (PreH10 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH11 : ((Zlength (l)) = n)) (PreH12 : (0 <= n)) (PreH13 : (n <= 50000)) (PreH14 : (0 <= left_pre)) (PreH15 : (left_pre <= right_pre)) (PreH16 : (right_pre < n)) ,
  TT && emp 
|--
  “ (range_nondecreasing l1_3 left_pre right_pre ) ” 
  &&  “ (same_outside_range l l1_3 left_pre right_pre ) ” 
...
(
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (PreH1 : (retval >= right_pre)) (PreH2 : (retval <= left_pre)) (PreH3 : (left_pre <= retval)) (PreH4 : (retval <= right_pre)) (PreH5 : (Permutation l l1_2 )) (PreH6 : (same_outside_range l l1_2 left_pre right_pre )) (PreH7 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH8 : ((Zlength (l)) = n)) (PreH9 : (0 <= n)) (PreH10 : (n <= 50000)) (PreH11 : (0 <= left_pre)) (PreH12 : (left_pre <= right_pre)) (PreH13 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1_2 )
|--
  EX (l1: (@list Z)) ,
  “ (Permutation l l1 ) ” 
...
(
forall (right_pre: Z) (left_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (PreH1 : (retval >= right_pre)) (PreH2 : (retval <= left_pre)) (PreH3 : (left_pre <= retval)) (PreH4 : (retval <= right_pre)) (PreH5 : (Permutation l l1_2 )) (PreH6 : (same_outside_range l l1_2 left_pre right_pre )) (PreH7 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH8 : ((Zlength (l)) = n)) (PreH9 : (0 <= n)) (PreH10 : (n <= 50000)) (PreH11 : (0 <= left_pre)) (PreH12 : (left_pre <= right_pre)) (PreH13 : (right_pre < n)) ,
  TT && emp 
|--
...
(
forall (right_pre: Z) (left_pre: Z) (arr_pre: Z) (n: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1: (@list Z)) (PreH1 : (right_pre <= INT_MAX)) (PreH2 : (left_pre <= INT_MAX)) (PreH3 : (retval <= INT_MAX)) (PreH4 : (right_pre >= INT_MIN)) (PreH5 : (left_pre >= INT_MIN)) (PreH6 : (retval >= INT_MIN)) (PreH7 : (retval < right_pre)) (PreH8 : (Permutation l1_2 l1 )) (PreH9 : (same_outside_range l1_2 l1 left_pre (retval - 1 ) )) (PreH10 : (range_nondecreasing l1 left_pre (retval - 1 ) )) (PreH11 : (retval > left_pre)) (PreH12 : (left_pre <= retval)) (PreH13 : (retval <= right_pre)) (PreH14 : (Permutation l l1_2 )) (PreH15 : (same_outside_range l l1_2 left_pre right_pre )) (PreH16 : (partitioned_at l1_2 left_pre right_pre retval )) (PreH17 : ((Zlength (l)) = n)) (PreH18 : (0 <= n)) (PreH19 : (n <= 50000)) (PreH20 : (0 <= left_pre)) (PreH21 : (left_pre <= right_pre)) (PreH22 : (right_pre < n)) ,
  (IntArray.full arr_pre n l1 )
  **  ((( &( "p" ) )) # Int  |-> retval)
  **  ((( &( "arr" ) )) # Ptr  |-> arr_pre)
  **  ((( &( "left" ) )) # Int  |-> left_pre)
