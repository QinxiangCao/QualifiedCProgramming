...
Proof.
  ...
  { subst l_next.
    eapply row_elim_prefix_update; eauto; lia. }
  destruct (Z_lt_dec (j + 1) cols).
  - Left. Right.
    Exists (zfactor_low_level_spec * (Znth (pivot_pre * cols + j) lcur_2 0))
      (Znth (target_pre * cols + j) lcur_2 0 -
        zfactor_low_level_spec * (Znth (pivot_pre * cols + j) lcur_2 0))
      l_next.
...
Proof.
  unfold row_elim_mod_gmp_return_wit_1.
  left.
  intros.
  assert (Hrep_elim :
...
Proof.
  unfold row_elim_mod_gmp_return_wit_2.
  left.
  intros.
  assert (Hrep_elim :
    rep_matrix lcur n_pre (n_pre + 1)
...
Proof.
  unfold row_elim_mod_gmp_return_wit_3.
  left.
  intros.
  assert (Hrep_elim :
    rep_matrix lcur n_pre (n_pre + 1)
...
Proof.
  unfold row_elim_mod_gmp_return_wit_4.
  left.
  intros.
  assert (Hrep_elim :
    rep_matrix lcur n_pre (n_pre + 1)
...
Lemma proof_of_row_elim_mod_gmp_partial_solve_wit_8_pure : row_elim_mod_gmp_partial_solve_wit_8_pure.
Proof.
  unfold row_elim_mod_gmp_partial_solve_wit_8_pure.
  right.
  intros.
