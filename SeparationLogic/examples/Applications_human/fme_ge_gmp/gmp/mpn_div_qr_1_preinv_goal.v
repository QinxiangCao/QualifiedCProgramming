...
|--
  EX (d0_orig: Z) ,
  “ (d1_orig_2 = (d_orig_bare * (Z.pow (2) (shift_orig_2)) )) ” 
  &&  “ (d1_orig_2 = (d_orig_bare * (Z.pow (2) (shift_orig_2)) )) ” 
  &&  “ (d1_orig_2 = (d_orig_bare * (Z.pow (2) (shift_orig_2)) )) ” 
  &&  “ (nn0_bare > 0) ” 
  &&  “ (nn0_bare <= INT_MAX) ” 
...
|--
  ...
  &&  “ (0 <= retval) ” 
  &&  “ (retval < d1_orig) ” 
  &&  “ (((carry * (Z.pow (UINT_MOD) (nn0_bare)) ) + (list_to_Z (UINT_MOD) (l_out)) ) = (((((list_to_Z (UINT_MOD) (l_done)) * (Z.pow (UINT_MOD) (((nn0_bare - 1 ) + 1 ))) ) * d1_orig ) + (retval * (Z.pow (UINT_MOD) (((nn0_bare - 1 ) + 1 ))) ) ) + (list_to_Z (UINT_MOD) ((sublist (0) (((nn0_bare - 1 ) + 1 )) (l_out)))) )) ” 
  &&  “ (shift_orig_2 > 0) ” 
  &&  “ (qp0_bare = 0) ” 
  &&  “ (((carry * (Z.pow (UINT_MOD) (nn0_bare)) ) + (list_to_Z (UINT_MOD) (l_out)) ) = ((list_to_Z (UINT_MOD) (l_np_bare)) * (Z.pow (2) (shift_orig_2)) )) ”
  &&  emp
).
...
|--
  ...
  &&  “ ((Zlength (l_np_bare)) = nn0_bare) ” 
  &&  “ ((Zlength (l_cur)) = nn0_bare) ” 
  &&  “ ((Zlength (l_done_2)) = (nn0_bare - (nn + 1 ) )) ” 
  &&  “ (list_within_bound UINT_MOD l_np_bare ) ” 
  &&  “ (list_within_bound UINT_MOD l_cur ) ” 
  ...
  &&  “ (rv < d1_orig) ” 
  &&  “ (qp0_bare <> 0) ” 
  &&  “ (((carry * (Z.pow (UINT_MOD) (nn0_bare)) ) + (list_to_Z (UINT_MOD) (l_cur)) ) = (((((list_to_Z (UINT_MOD) (l_done_2)) * (Z.pow (UINT_MOD) ((nn + 1 ))) ) * d1_orig ) + (r_old * (Z.pow (UINT_MOD) ((nn + 1 ))) ) ) + (list_to_Z (UINT_MOD) ((sublist (0) ((nn + 1 )) (l_cur)))) )) ” 
  &&  “ (shift_orig_2 > 0) ” 
  &&  “ (np = qp0_bare) ” 
  &&  “ (tp = qp0_bare) ” 
  &&  “ (tn = 0) ” 
...
|--
  ...
  &&  “ (rv < d1_orig) ” 
  &&  “ (qp0_bare <> 0) ” 
  &&  “ (((0 * (Z.pow (UINT_MOD) (nn0_bare)) ) + (list_to_Z (UINT_MOD) (l_np_bare)) ) = (((((list_to_Z (UINT_MOD) (l_done_2)) * (Z.pow (UINT_MOD) ((nn + 1 ))) ) * d1_orig ) + (r_old * (Z.pow (UINT_MOD) ((nn + 1 ))) ) ) + (list_to_Z (UINT_MOD) ((sublist (0) ((nn + 1 )) (l_np_bare)))) )) ” 
  &&  “ (np = np0_bare) ” 
  &&  “ (tp = 0) ” 
  &&  “ (tn = 0) ” 
  &&  “ (((r_old * UINT_MOD ) + (Znth nn l_np_bare 0) ) = ((qv * d1_orig ) + rv )) ”
  &&  emp
).
...
|--
  ...
  &&  “ (0 <= rv) ” 
  &&  “ (rv < d1_orig) ” 
  &&  “ (((carry * (Z.pow (UINT_MOD) (nn0_bare)) ) + (list_to_Z (UINT_MOD) (l_cur_2)) ) = (((((list_to_Z (UINT_MOD) (l_done)) * (Z.pow (UINT_MOD) (((nn - 1 ) + 1 ))) ) * d1_orig ) + (rv * (Z.pow (UINT_MOD) (((nn - 1 ) + 1 ))) ) ) + (list_to_Z (UINT_MOD) ((sublist (0) (((nn - 1 ) + 1 )) (l_cur_2)))) )) ” 
  &&  “ (shift_orig_2 > 0) ” 
  &&  “ (qp0_bare = 0) ” 
  &&  “ (np = tp) ” 
  &&  “ (((carry * (Z.pow (UINT_MOD) (nn0_bare)) ) + (list_to_Z (UINT_MOD) (l_cur_2)) ) = ((list_to_Z (UINT_MOD) (l_np_bare)) * (Z.pow (2) (shift_orig_2)) )) ”
  &&  emp
).
...
|--
  “ ((Z.shiftr r shift_orig) < d_orig_bare) ” 
  &&  “ (0 <= (Z.shiftr r shift_orig)) ” 
  &&  “ ((list_to_Z (UINT_MOD) (l_np_bare)) = (((list_to_Z (UINT_MOD) (l_q_2)) * d_orig_bare ) + (Z.shiftr r shift_orig) )) ”
  &&  (store_div_inverse inv0_bare 1 d_orig_bare )
).
