...
def _group_check(
    *,
    ...
    target = (
        ...
        / f"{config['case_name']}_{coq_identifier_slug(directory.name)}_check.v"
    )
    return run_coqc_check(
        ...
        group_check={
            ...
            "require_modules": [
                config["case_name"] + "_goal",
                config["case_name"] + "_proof_auto",
                config["case_name"] + "_proof_manual",
            ],
    ...
    *,
    ...
    if ready:
        ...
        parent_check = run_coqc_check(
            ...
            target_file=Path(config["check_file"]),
            target_kind="check",
            source_goal_version=str(base["source_goal_version"]),
