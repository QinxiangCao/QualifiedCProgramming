...
Proof.
  unfold generate_new_constraint_list_partial_solve_wit_1_pure.
  intros.
  Intros.
  entailer!.
  right.
...
Proof.
  unfold lia_deduction_partial_solve_wit_1_pure.
  left.
  intros.
  Intros.
  split_pures.
  - dump_pre_spatial.
    unfold lia_deduction_prog in PreH1.
    unfold lia_deduction_check_prog in PreH1.
...
Proof.
  ...
  prop_apply_p (InequList_coef_Zlength
...
Proof.
  ...
  prop_apply_p (InequList_coef_Zlength p1_high_level_spec (n_pre + 1) l1_high_level_spec).
  Intros_p Hcoef_lengths.
...
Proof.
  pre_process.
  Intros BP0_remain. Intros BP0_lower. Intros BP0_upper.
  prop_apply_p (InequList_coef_Zlength p1_low_level_spec_aux (n_pre + 1) l1_low_level_spec_aux).
  Intros_p Hcoef_lengths.
...
Proof.
  pre_process.
  prop_apply_p (InequList_coef_Zlength r1_pre n_low_level_spec_aux_with_rel l1_low_level_spec_aux_with_rel).
  prop_apply_p (InequList_coef_Zlength r2_pre n_low_level_spec_aux_with_rel l2_low_level_spec_aux_with_rel).
  Intros_p Hlen_r1.
  Intros_p Hlen_r2.
...
Proof.
  pre_process.
  prop_apply_p (InequList_coef_Zlength r1_pre n_high_level_spec l1_high_level_spec).
  prop_apply_p (InequList_coef_Zlength r2_pre n_high_level_spec l2_high_level_spec).
  Intros_p Hlen_r1.
  Intros_p Hlen_r2.
...
Proof.
  ...
  prop_apply_p (mpz_coef_array_length
...
Proof.
  ...
  prop_apply_p (mpz_coef_array_length r1_pre (num_pre + 1) c1_high_level_spec Hr1_nonnull).
  prop_apply_p (mpz_coef_array_length r2_pre (num_pre + 1) c2_high_level_spec Hr2_nonnull).
  Intros_p Hlen_r1.
  Intros_p Hlen_r2.
