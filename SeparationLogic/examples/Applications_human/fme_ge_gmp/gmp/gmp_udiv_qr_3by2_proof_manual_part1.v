...
Proof.
  unfold gmp_udiv_qr_3by2_entail_wit_5_1; intros.
...
Proof.
  unfold gmp_udiv_qr_3by2_entail_wit_5_2; intros.
  change UINT_MOD with 4294967296 in *.
  change UINT_MAX with 4294967295 in *.
  change (4294967296 ÷ 2) with 2147483648 in *.
  set (qlo := unsigned_last_nbits (w0_value + n1_pre) 32) in *.
...
Proof.
  unfold gmp_udiv_qr_3by2_entail_wit_5_3; intros.
  change UINT_MOD with 4294967296 in *.
  change UINT_MAX with 4294967295 in *.
  change (4294967296 ÷ 2) with 2147483648 in *.
  set (qlo := unsigned_last_nbits (w0_value + n1_pre) 32) in *.
...
Proof.
  unfold gmp_udiv_qr_3by2_entail_wit_5_4; intros.
  change UINT_MOD with 4294967296 in *.
  change UINT_MAX with 4294967295 in *.
  change (4294967296 ÷ 2) with 2147483648 in *.
  set (qlo := unsigned_last_nbits (w0_value + n1_pre) 32) in *.
