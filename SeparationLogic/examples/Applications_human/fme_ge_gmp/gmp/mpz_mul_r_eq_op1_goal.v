...
(
forall (op2_pre: Z) (op1_pre: Z) (rop_pre: Z) (z2: Z) (z1: Z) (rptr: Z) (rsize: Z) (rcap: Z) (op1ptr: Z) (op1size: Z) (op1cap: Z) (op2ptr: Z) (op2size: Z) (op2cap: Z) (l1: (@list Z)) (l2: (@list Z)) (rn: Z) (un: Z) (vn: Z) (sign: Z) (retval: Z) (PreH1 : (op2cap <= INT_MAX)) (PreH2 : (op2size <= INT_MAX)) (PreH3 : (op1cap <= INT_MAX)) (PreH4 : (op1size <= INT_MAX)) (PreH5 : (sign <= INT_MAX)) (PreH6 : (rn <= INT_MAX)) (PreH7 : (op2cap >= INT_MIN)) (PreH8 : (op2size >= INT_MIN)) (PreH9 : (op1cap >= INT_MIN)) (PreH10 : (op1size >= INT_MIN)) (PreH11 : (sign >= INT_MIN)) (PreH12 : (vn >= INT_MIN)) (PreH13 : (un >= INT_MIN)) (PreH14 : (rn >= INT_MIN)) (PreH15 : (retval <> 0)) (PreH16 : (rop_pre = op1_pre)) (PreH17 : (rn = (un + vn ))) (PreH18 : (un > 0)) (PreH19 : (vn > 0)) (PreH20 : (0 <= sign)) (PreH21 : (sign <= 1)) (PreH22 : (mpz_mul_sign sign op1size op2size )) (PreH23 : (un <= INT_MAX)) (PreH24 : (vn <= INT_MAX)) (PreH25 : ((un + vn ) <= INT_MAX)) (PreH26 : (un = (Zabs (op1size)))) (PreH27 : (vn = (Zabs (op2size)))) (PreH28 : (op1size <> 0)) (PreH29 : (op2size <> 0)) (PreH30 : (same_sign z1 op1size )) (PreH31 : (same_sign z2 op2size )) (PreH32 : (rptr = op1ptr)) (PreH33 : (rsize = op1size)) (PreH34 : (rcap = op1cap)) (PreH35 : ((Zabs (rsize)) <= rcap)) (PreH36 : (rcap >= 0)) (PreH37 : (rcap <= INT_MAX)) (PreH38 : ((Zlength (l1)) = un)) (PreH39 : ((Zlength (l2)) = vn)) (PreH40 : (list_within_bound UINT_MOD l1 )) (PreH41 : (list_within_bound UINT_MOD l2 )) (PreH42 : ((list_to_Z (UINT_MOD) (l1)) = (Zabs (z1)))) (PreH43 : ((list_to_Z (UINT_MOD) (l2)) = (Zabs (z2)))) (PreH44 : ((last (l1) (1)) >= 1)) (PreH45 : ((last (l2) (1)) >= 1)) ,
  ((&((retval)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |->_)
  **  ((&((retval)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |->_)
  **  ((&((retval)  # "__mpz_struct" ->ₛ "_mp_d")) # Ptr  |->_)
  **  ((( &( "rop" ) )) # Ptr  |-> rop_pre)
